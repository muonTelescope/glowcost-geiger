...
views={'schematic':(-2,-37,65,32),'schematic-power':(-2,9,63,27),'schematic-feedback':(-2,-7,63,9),'schematic-pulse':(-2,-30,41,-8),'schematic-discharge':(41,-27,63,-8)}
...
print('Rendered full schematic and four readable detail views')
